...
function styleField() {
    ...
    return [
    'case',
        ['all', ['<=', ['get', candidate1 + ' - PERCENTAGE'], 2.0], ['<=', ['get', candidate2 + ' - PERCENTAGE'], 2.0]], '#e8e8e8',
        ['all', ['>', ['get', candidate1 + ' - PERCENTAGE'], 2.0], ['<=', ['get', candidate1 + ' - PERCENTAGE'], 5.0], ['<=', ['get', candidate2 + ' - PERCENTAGE'], 2.0]], '#ace4e4',
        ['all', ['>', ['get', candidate1 + ' - PERCENTAGE'], 5.0], ['<=', ['get', candidate2 + ' - PERCENTAGE'], 2.0]], '#5ac8c8',
        ['all', ['<=', ['get', candidate1 + ' - PERCENTAGE'], 2.0], ['>', ['get', candidate2 + ' - PERCENTAGE'], 2.0], ['<=', ['get', candidate2 + ' - PERCENTAGE'], 5.0]], '#dfb0d6',
        ['all', ['<=', ['get', candidate1 + ' - PERCENTAGE'], 2.0], ['>', ['get', candidate2 + ' - PERCENTAGE'], 5.0]], '#be64ac',
        ['all', ['>', ['get', candidate1 + ' - PERCENTAGE'], 2.0], ['<=', ['get', candidate1 + ' - PERCENTAGE'], 5.0], ['>', ['get', candidate2 + ' - PERCENTAGE'], 2.0], ['<=', ['get', candidate2 + ' - PERCENTAGE'], 5.0]], '#a5add3',
        ['all', ['>', ['get', candidate1 + ' - PERCENTAGE'], 2.0], ['<=', ['get', candidate1 + ' - PERCENTAGE'], 5.0], ['>', ['get', candidate2 + ' - PERCENTAGE'], 5.0]], '#8c62aa',
        ['all', ['>', ['get', candidate1 + ' - PERCENTAGE'], 5.0], ['>', ['get', candidate2 + ' - PERCENTAGE'], 2.0], ['<=', ['get', candidate2 + ' - PERCENTAGE'], 5.0]], '#5698b9',
